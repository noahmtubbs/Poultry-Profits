...
function drawCashRegister()
    if cashRegisterOpen and currentCustomer then
        ...
        love.graphics.print("Price per egg: KSH " .. _G.eggPrice, 130, 180)
        ...
        if _G.currentLevel == 1 then
            ...
            love.graphics.print("Change to give: KSH ??", 130, 280)
        end
    ...
    if cashRegisterOpen then
        if key == "return" then
            ...
            if changeInput == changeToGive then
                ...
                customersServed = customersServed + 1 -- Increment customers served
